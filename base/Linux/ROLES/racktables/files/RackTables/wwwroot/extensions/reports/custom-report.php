...
function renderCustomReport()
{
    ...
    echo '<td valign="top">
           <table class="searchTable">
             <tr><td><input type="checkbox" name="name" value="1" ';if (isset($_POST['name'])) echo ' checked="checked"'; echo '> Name</td></tr>
             <tr class="odd"><td><input type="checkbox" name="label" value="1" ';if (isset($_POST['label'])) echo ' checked="checked"'; echo '> Label</td></tr>
             <tr><td><input type="checkbox" name="asset_no" value="1" ';if (isset($_POST['asset_no'])) echo ' checked="checked"'; echo '> Asset Tag</td></tr>
             <tr class="odd"><td><input type="checkbox" name="location" value="1" ';if (isset($_POST['location'])) echo ' checked="checked"'; echo '> Location</td></tr>
             <tr><td><input type="checkbox" name="has_problems" value="1" ';if (isset($_POST['has_problems'])) echo ' checked="checked"'; echo '> Has Problems</td></tr>
             <tr class="odd"><td><input type="checkbox" name="comment" value="1" ';if (isset($_POST['comment'])) echo ' checked="checked"'; echo '> Comment</td></tr>
             <tr><td><input type="checkbox" name="runs8021Q" value="1" ';if (isset($_POST['runs8021Q'])) echo ' checked="checked"'; echo '> Runs 8021Q</td></tr>
             <tr class="odd"><td><input type="checkbox" name="MACs" value="1" ';if (isset($_POST['MACs'])) echo ' checked="checked"'; echo '> MACs</td></tr>
             <tr><td><input type="checkbox" name="IPs" value="1" ';if (isset($_POST['IPs'])) echo ' checked="checked"'; echo '> IPs</td></tr>
             <tr class="odd"><td><input type="checkbox" name="Tags" value="1" ';if (isset($_POST['Tags'])) echo ' checked="checked"'; echo '> Tags</td></tr>
             <tr><td><input type="checkbox" name="Ports" value="1" ';if (isset($_POST['Ports'])) echo ' checked="checked"'; echo '> Ports</td></tr>
           </table>
         </td>';
 ...
 * @return bool display
 */
function validateColums($_POST) {
    if (isset( $_POST['name'] ) )
        return true;

    if ( (!isset($_POST['label'])) &&
         (!isset($_POST['asset_no'])) &&
         (!isset($_POST['has_problems'])) &&
         (!isset($_POST['comment'])) &&
         (!isset($_POST['runs8021Q'])) &&
         (!isset($_POST['location'])) &&
         (!isset($_POST['MACs'])) &&
         (!isset($_POST['label'])) &&
      (!isset($_POST['attributeIDs'])) ) {
     return true;
    }
